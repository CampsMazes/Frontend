...
const Hero = () => {
    return (
        <section className="hero bg-green py-12 xl:pt-12 xl:pb-0 overflow-hidden">
                        ...
                        <div className="mt-12">
                            <form>
                                ...
                                <div className="relative flex">
                                    ...
                                    <button type="submit"
                                        className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary font-medium rounded-lg text-sm px-12 py-1 ml-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        Let's Go
                                    </button>
                                </div>
                            </form>
